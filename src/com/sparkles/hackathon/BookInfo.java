...
public class BookInfo {
	...
	public Map<String, Map<String, String>> getFinalList (String json) throws Exception {
		final File folder = new File ("C:/Users/Indhu/Desktop/CSV_FILES");
		Map<String, Map<String, String>> map = listFilesForFolder(folder);
		return map;
	}
	
	public Map<String, Map<String, String>> listFilesForFolder(final File folder) throws Exception {
	...
	public Map<String, Map<String, String>> readFileAndPopulate(final List<String> fileNames) throws Exception {
